...
<html lang="ko">
	<head>
		...
		<title>팀즈 클라우드 보이스 커넥트</title>
		
		<meta name="keywords" content="팀즈 클라우드 보이스 커넥트">
		<meta name="author" content="팀즈 클라우드 보이스 커넥트">
		<meta name="description" content="팀즈 클라우드 보이스 커넥트">
		
		<meta property="og:type" content="website">
		<meta property="og:title" content="팀즈 클라우드 보이스 커넥트">
		<meta property="og:url" content="http://teamsvoice.co.kr/">
		<meta property="og:description" content="팀즈 클라우드 보이스 커넥트">
					...
					<div id="fullpage">
						<section class="section" id="section1">
							<div class="container">
								<div class="content">
									<h1>
										<span class="outline">팀즈 클라우드</span> <br>
										<span>보이스 커텍트</span>
									</h1>
									<p>
										통신사 PSTN/Voip 유선 전화를<br>
										다양한 디바이스에서 편리하게 Teams를 통해 사용하세요!
									</p>
								</div>
							</div>
						...
						<section class="section" id="section2">
							<div class="container">
								<div class="content">
									<h1>
										<strong class="category">Product</strong>
										팀즈 클라우드 보이스 커넥트
									</h1>
									<p>
										팀즈 클라우드 보이스 커넥트는 MS Teams 기반의<br>
										통화서비스를 제공하고 관리하는 매니지드 서비스 패키지입니다.
									</p>
						...
						<section class="section" id="section3">
							<div class="container">
								<div class="content">
									<h1>
										<strong class="category">Service 01</strong>
										개통 서비스
									</h1>
									<p>
						...
						<section class="section" id="section4">
							<div class="container">
								<div class="content">
									<h1>
										<strong class="category">Service 02</strong>
										매니지드 서비스
									</h1>
									<p>
						...
						<section class="section" id="section5">
							<div class="container">
								<div class="content">
									<h1>
										<strong class="category">About us</strong>
										넷케이티아이
									</h1>
									<p>
									...
									<ul>
										<li>
											<h2>검증된 자격인증 및 엔지니어</h2>
											<p>
												Audiocodes Platinum 파트너,
												AudioCodes Session Border Controllers Essentials & Configuration 엔지니어,
												Microsoft 365 Certified : Teams Administrator Associate 엔지니어,
												다수의 클라우드 엔지니어
											</p>
										</li>
										<li>
											<h2>풍부한 경험 및 기술력</h2>
											<p>
												지난 10여 년간의 국내 인터넷전화 구축 및 연동 경험
												다수 고객사에 팀즈 통화서비스 구축 및 운영/유지관리
											</p>
										</li>
										<li>
											<h2>전국단위 수행/유지보수 조직</h2>
											<p>
												수도권 본사, 6개 광역지자체 지역센터, 14개 지역지사를 통한 전국단위 사업 수행 및 유지보수
											</p>
										</li>
										<li>
											<h2>관제센터 운용</h2>
											<p>
												관제 센터 상주인력의 고객 헬프데스크 대응,
												유사시 현장대응 출동 및 멀티티어 구조의 기술지원 체계
											</p>
										</li>
									</ul>
								</div>
