					...
					<fieldset>
						...
						<table border="1" cellspacing="0" cellpadding="0" class="table">
							...
							<tr>
								...
								<td>
									<ul class="input-list hor type1">
										<li>
											<input type="checkbox" name="u-tel" id="u-tel1" class="tv-chk">
											<label for="u-tel1">KT</label>
										</li>
										<li>
											<input type="checkbox" name="u-tel" id="u-tel2" class="tv-chk">
											<label for="u-tel2">SKBB</label>
										</li>
										<li>
											<input type="checkbox" name="u-tel" id="u-tel3" class="tv-chk">
						...
						<table border="1" cellspacing="0" cellpadding="0" class="table">
							...
							<tr>
								...
								<td>
									...
									<ul class="input-list hor type2">
										<li>
											<input type="checkbox" name="d1" id="d1-3" class="tv-chk">
											<label for="d1-3">SIP폰 전화기 연동</label>
										</li>
										<li>
											<input type="checkbox" name="d1" id="d1-4" class="tv-chk">
