		...
		<section class="section">
			<div class="container">
				...
				<div class="title-wrap">
					<h1 class="title-h1">이용약관</h1>
				</div>
				
				<div class="terms-text">
					<p>
						(주)넷케이티아이는 고객님의 개인정보를 중요시하며, "정보통신망 이용촉진 및 정보보호"에 관한 법률을 준수하고 있습니다.<br>
					...
					<ul>
						<li>
							...
							- 회원가입시 : 이름, 생년월일, 성별, 로그인ID , 비밀번호 , 휴대전화번호 , 이메일 , 회사 정보(이름, 부서, 직급)
						</li>
						<li>
							서비스 이용 과정이나 사업 처리 과정에서 서비스이용기록, 접속로그, 쿠키 기록이 생성되어 수집될 수 있습니다.
						</li>
					</ul>
					...
					<ul>
						<li>
							홈페이지 회원가입을 통한 개인정보 수집 이용약관 동의 후 수집
						</li>
					</ul>
					...
					<ul>
						<li>
							팀즈 클라우드 보이스 커넥트 매니지드 서비스 제공에 따른 문의, 변경, 장애처리
						</li>
						<li>
							회원 관리<br>
					...
					<h3>가. 회사 내부방침에 의한 정보보유 사유</h3>
					<p>회원이 탈퇴한 경우에도 불량회원의 부정한 이용의 재발을 방지, 분쟁해결 및 수사기관의 요청에 따른 협조를 위하여, 이용계약 해지일로부터 5년간 회원의 정보를 보유할 수 있습니다.</p>
					
					<h3>나. 관련 법령에 의한 정보 보유 사유</h3>
					...
					<ul>
						...
						<li>
							이용자들의 개인정보 조회,수정을 위해서는 회원정보 수정 및 회원탈퇴를 클릭하여 본인 확인 절차를 거치신 후 직접 열람, 정정 또는 탈퇴가 가능합니다.
						</li>
						<li>
					...
					<p>회사는 고객의 개인정보를 보호하고 개인정보와 관련한 불만을 처리하기 위하여 아래와 같이 관련 부서 및 개인정보보호담당자를 지정하고 있습니다.</p>
					...
					<div class="box">
						성명 : 신영준<br>
						소속 : (주)넷케이티아이<br>
						전화번호 : 031-786-9990<br>
						이메일 : teamsvoice@kti.co.kr
					</div>
					
					<p>
						귀하께서는 회사의 서비스를 이용하시며 발생하는 모든 개인정보보호 관련 민원을 개인정보보호담당자 혹은 담당부서로 신고하실 수 있습니다.<br>
