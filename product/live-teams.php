		...
		<section class="section">
			...
			<div class="container">
				<h1 class="section-tlt1">
					<span>팀즈에서 다이렉트 라우팅을 통한 </span>
					<span>PSTN 연동</span>
				</h1>
				
				<ol class="direct-routing-wrapper">
			...
			<div class="container managed-product live-teams-pro" id="live-teams-pro">
				...
				<figure class="mobile-img">
					<img src="../assets/image/product/m-live-teams-pro.png" alt="">
				</figure>
				...
				<div class="device-box box1">
					...
					<div class="item">
						<ul>
							...
							<li class="logo-box-wrap">
								<div class="logo-box">
									<figure>
										<img src="../assets/image/product/teams-solution1-1.png" alt="ZAISOFT">
									</figure>
									<span>기술지원 자이소프트</span>
								</div>
							</li>
						</ul>
					</div>
